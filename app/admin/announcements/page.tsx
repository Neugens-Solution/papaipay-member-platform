...
export default function AnnouncementsPage() {
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <PageHeader eyebrow="Announcements" title="Announcements" description="Create and maintain member-facing operational announcements." action={<Link className="rounded-md bg-papaipay-green px-4 py-2 text-sm font-bold text-white" href="/admin/announcements/create">Create Announcement</Link>} />
      <TableWrap>
