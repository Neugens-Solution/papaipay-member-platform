...
export default function CreateAnnouncementPage() {
  return <div className="mx-auto max-w-4xl space-y-6"><BackLink href="/admin/announcements" /><PageHeader title="Create Announcement" description="Create and publish admin announcements." /><AnnouncementForm /></div>;
}
    ...
    <Card>
      <div className="grid gap-4">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <label><span className="text-sm font-bold">Publish Date</span><input className="mt-2 min-h-11 w-full rounded-lg border border-slate-200 px-3" /></label>
