...
export default function AdminUsersPage() {
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <PageHeader title="Admin Users" description="Manage Super Admin, Admin and Manager users. All roles currently access the same UI." action={<Link className="rounded-md bg-papaipay-green px-4 py-2 text-sm font-bold text-white" href="/admin/admin-users/invite">Create Admin User</Link>} />
