  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <input type="date" aria-label="Activity start date" className="min-h-11 rounded-lg border border-slate-200 bg-white px-3 text-sm outline-none focus:border-papaipay-green" />
        <input type="date" aria-label="Activity end date" className="min-h-11 rounded-lg border border-slate-200 bg-white px-3 text-sm outline-none focus:border-papaipay-green" />
