...
export default function CampaignOutcomePage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5">
      <Link href="/member/opportunities?tab=completed" className="inline-flex items-center rounded-md text-sm font-bold text-papaipay-green hover:text-papaipay-ink">← Back to Completed Campaigns</Link>
      <header className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="bg-gradient-to-br from-emerald-50 to-white p-6 sm:p-8">
          ...
          <div className="mt-3 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-papaipay-ink">Campaign Outcome</h1>
