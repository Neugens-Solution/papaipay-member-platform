...
const declarations = ["I understand this listing involves risk.", "I have read the important information.", "I understand projected return is not guaranteed.", "I confirm the information I provided is accurate."];
